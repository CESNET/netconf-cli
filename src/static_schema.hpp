...
public:
    ...
    void addLeafUnion(const std::string& location, const std::string& name, std::vector<yang::leaf> types);
...
private:
    ...
    const std::set<std::string> enumValues(const std::string& path) const;
