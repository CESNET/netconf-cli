...
public:
    ...
    std::optional<libyang::DataNode> getConfig(const NC_DATASTORE datastore,
    ...
    std::string_view getSchema(const std::string_view identifier, const std::optional<std::string_view> version);
