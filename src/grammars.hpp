...
x3::rule<leaf_data_identityRef_data_class, std::string> const leaf_data_identityRef_data = "leaf_data_identityRef_data";
...
// This intermediate rule is neccessary for coercing to std::string.
// TODO: make the module identifier optional or otherwise do something with the modules
auto const leaf_data_identityRef_data_def =
    module_identifier >> char_(":") >> ((alpha | char_("_")) >> *(alnum | char_("_") | char_("-") | char_(".")));
