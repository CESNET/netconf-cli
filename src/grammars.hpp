...
x3::rule<leaf_data_int_class, int8_t> const leaf_data_int8 = "leaf_data_int8";
x3::rule<leaf_data_uint_class, uint8_t> const leaf_data_uint8 = "leaf_data_uint8";
x3::rule<leaf_data_int_class, int16_t> const leaf_data_int16 = "leaf_data_int16";
x3::rule<leaf_data_uint_class, uint16_t> const leaf_data_uint16 = "leaf_data_uint16";
x3::rule<leaf_data_int_class, int32_t> const leaf_data_int32 = "leaf_data_int32";
x3::rule<leaf_data_uint_class, uint32_t> const leaf_data_uint32 = "leaf_data_uint32";
x3::rule<leaf_data_int_class, int64_t> const leaf_data_int64 = "leaf_data_int64";
x3::rule<leaf_data_uint_class, uint64_t> const leaf_data_uint64 = "leaf_data_uint64";
