...
private:
    void checkRpc(const std::variant<commit_, discard_, copy_, prepare_, switch_>& cmd) const;
    void checkRpcContext(const std::variant<move_, set_, cd_, create_, delete_>& cmd) const;
