...
public:
    SysrepoAccess(const SysrepoAccess& src) = delete;
    SysrepoAccess(SysrepoAccess&& src) noexcept;
    SysrepoAccess& operator=(const SysrepoAccess& src) = delete;
    SysrepoAccess& operator=(SysrepoAccess&& src) noexcept;
