...
std::string nodeToSchemaString::operator()(const nodeup_&) const
{
    return "..";
}

template <class T>
std::string nodeToSchemaString::operator()(const T& node) const
{
    return node.m_name;
}

std::string nodeToDataString::operator()(const listElement_& node) const
{
...
std::string nodeToDataString::operator()(const nodeup_&) const
{
    return "..";
}

template <class T>
std::string nodeToDataString::operator()(const T& node) const
{
    return node.m_name;
}
