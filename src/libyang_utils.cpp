...
namespace {
//const libyang::Collection<libyang::DataNode, libyang::IterationType::Dfs>&
...
template
void lyNodesToTree<libyang::DataNodeSet>(DatastoreAccess::Tree& res, libyang::DataNodeSet items, std::optional<std::string> ignoredXPathPrefix);
