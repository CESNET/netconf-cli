...
void Interpreter::operator()(const action_& action) const
{
    m_datastore.initiateAction(pathToString(toCanonicalPath(action.m_path)));
    m_parser.changeNode(action.m_path);
}
