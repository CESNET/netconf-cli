...
public:
    ...
    /** addSchemaString
     * Add a new module passed as a YANG string.
     */
    void addSchemaString(const char* schema);

    /** addSchemaFile
     * Add a new module from a file.
     */
...
private:
    ...
    /** getSchemaNode
     * This method returns a single Schema_Node if the criteria matches only one, otherwise nullptr.
     */
