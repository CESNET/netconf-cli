...
Usage:
  yang-cli [--configonly] [--non-strict] [-s <search_dir>] [-e enable_features]... [-i data_file]... <schema_file_or_module_name>...
  yang-cli (-h | --help)
  yang-cli --version
...
Options:
  ...
  --non-strict          Silently ignore data with no available schema file)";
...
int main(int argc, char* argv[])
{
    ...
    auto strict = args.at("--non-strict").asBool() ? StrictDataParsing::No : StrictDataParsing::Yes;
