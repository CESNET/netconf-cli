...
#error "Unknown backend"
    ...
    SECTION("moving leaflist instances")
    {
        ...
        SECTION("end")
        {
            ...
            // TODO: this seems fishy... it does however make sense: sysrepo can't possibly know how I rearranged these
            // nodes, because I dump the data from YangAccess via sysrepoctl.
...
#if not defined(netconf_BACKEND) // TODO asked on slack
...
#error "Unknown backend"
    ...
    // TODO: does it still? could be the order is the std::lists inside sysrepo::Subscription
