...
#error "Unknown backend"
    ...
    SECTION("listKeys")
    {
        ...
        SECTION("example-schema:selectedNumbers")
        {
            ...
            path.m_nodes.push_back(schemaNode_{module_{"example-schema"}, list_("selectedNumbers")});
            expected = {
                {"value", "45"},
                {"value", "99"},
                {"value", "127"}
        ...
        SECTION("example-schema:animalWithColor")
        {
            ...
            path.m_nodes.push_back(schemaNode_{module_{"example-schema"}, list_("animalWithColor")});
            expected = {
                {"color", "'brown'"},
                {"color", "'grey'"},
                {"color", "'white'"},
