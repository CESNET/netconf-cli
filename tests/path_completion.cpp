...
TEST_CASE("path_completion")
{
    ...
    schema->addLeaf("/example:anoda", "example:iid", yang::InstanceIdentifier{yang::InstanceIdentifier::RequireInstance::Required});
    ...
    SECTION("node name completion")
    {
        ...
        SECTION("set example:anoda/iid ")
        {
            ...
            // FIXME: complete with a slash for the absolute path
            /* expectedCompletions = {"/"}; */
            /* expectedContextLength = 1; */
            expectedCompletions = {};
            expectedContextLength = 0;
