...
TEST_CASE("path_completion")
{
    ...
    SECTION("node name completion")
    {
        ...
        {
            input = "ls ";
            expected = {"example:*", "example:ano/", "example:anoda/", "example:bota/", "example:leafInt ", "example:list[", "example:ovoce[", "example:ovocezelenina[", "example:twoKeyList[", "second:amelie/"};
        }
