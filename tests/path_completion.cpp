...
TEST_CASE("path_completion")
{
    ...
    SECTION("node name completion")
    {
        ...
        {
            input = "ls ";
            expected = {"example:*", "second:*", "example:ano", "example:anoda", "example:bota", "example:leafInt", "example:list", "example:ovoce", "example:ovocezelenina", "example:twoKeyList", "second:amelie"};
        }
