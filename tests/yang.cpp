...
const char* schema = R"(module example-schema {
...
TEST_CASE("yangschema")
{
    ...
    SECTION("isContainer")
    {
        ...
        {
            node.first = "example-schema"; node.second = "a";
        }
    ...
    SECTION("isLeaf")
    {
        ...
        {
            node.first = "example-schema"; node.second = "leafString";
        }

        SECTION("example-schema:a/leafa")
        {
            path.m_nodes.push_back(node_(module_{"example-schema"}, container_("a")));
            node.first = "example-schema"; node.second = "leafa";
        }
    ...
    SECTION("isList")
    {
        ...
        {
            node.first = "example-schema"; node.second = "_list";
        }

        SECTION("example-schema:twoKeyList")
        {
            node.first = "example-schema"; node.second = "twoKeyList";
        }
    ...
    {
        node.first = "example-schema"; node.second = "leafEnum";
        std::string value;
    ...
    SECTION("leafType")
    {
        ...
        SECTION("leafDecimal")
        {
            node.first = "example-schema"; node.second = "leafDecimal";
            type = yang::LeafDataTypes::Decimal;
        }

        SECTION("leafBool")
        {
            node.first = "example-schema"; node.second = "leafBool";
            type = yang::LeafDataTypes::Bool;
        }

        SECTION("leafInt")
        {
            node.first = "example-schema"; node.second = "leafInt";
            type = yang::LeafDataTypes::Int;
        }

        SECTION("leafUint")
        {
            node.first = "example-schema"; node.second = "leafUint";
