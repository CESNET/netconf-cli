...
TEST_CASE("yangschema")
{
        ...
        SECTION("availableNodes")
        {
            ...
            SECTION("modules")
            {
                ...
                SECTION("example-schema")
                {
                    ...
                    // FIXME: Figure out why new libyang doesn't show the commented out nodes
                    // It is probably because of input/output nodes. In libyang, lys_getnext has an argument for
                    // enabling output instead of input nodes.
                    expectedRecursive = {
    ...
    SECTION("negative")
    {
        ...
        // FIXME: https://github.com/CESNET/libyang/issues/1679
