    ...
    SECTION("availableNodes")
    {
        ...
        SECTION("cwd: /example:a")
        {
            ...
            SECTION("arg: example:a2")
            {
                ...
                expectedPath = schemaPath_{Scope::Absolute, {{module_{"example"}, container_{"a"}}, {module_{"example"}, container_{"a2"}}}};
            }

            SECTION("arg: example:listInCont")
            {
                lsArg = dataPath_{Scope::Relative, {{list_{"listInCont"}}}};
                expectedPath = schemaPath_{Scope::Absolute, {{module_{"example"}, container_{"a"}}, {module_{"example"}, list_{"listInCont"}}}};
            }
        ...
        SECTION("cwd: /example:list")
        {
            ...
            SECTION("arg: example:contInList")
            {
                ...
                expectedPath = schemaPath_{Scope::Absolute, {{module_{"example"}, list_{"list"}}, {module_{"example"}, container_{"contInList"}}}};
            }
