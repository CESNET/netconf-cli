...
public:
    ...
    MAKE_CONST_MOCK1(leafType, yang::TypeInfo(const std::string&));
    MAKE_CONST_MOCK2(leafType, yang::TypeInfo(const schemaPath_&, const ModuleNodePair&));
    ...
    MAKE_CONST_MOCK1(nodeType, yang::NodeTypes(const std::string&));
    MAKE_CONST_MOCK2(nodeType, yang::NodeTypes(const schemaPath_&, const ModuleNodePair&));
