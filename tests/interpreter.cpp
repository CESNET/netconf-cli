...
TEST_CASE("rpc")
{
    ...
    SECTION("entering/leaving rpc context")
    {
        ...
        SECTION("can't leave the context with cd")
        {
            ...
            REQUIRE_NOTHROW(boost::apply_visitor(Interpreter(parser, proxyDatastore), command_{cd_{{}, dataPath_{Scope::Relative, {dataNode_{container_{"launch-nukes-container"}}}}}}));
