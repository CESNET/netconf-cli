...
TEST_CASE("interpreter tests")
{
    ...
    SECTION("set")
    {
        ...
        SECTION("setting int32")
        {
            ...
            inputData = 10;
            expectations.push_back(NAMED_REQUIRE_CALL(datastore, setLeaf("/mod:myInt", 10)));
        }
        ...
        SECTION("setting identityRef with module")
        {
            ...
            expectations.push_back(NAMED_REQUIRE_CALL(datastore, setLeaf("/mod:animal", identityRef_{"MoreAnimals", "Fennec"})));
        }
