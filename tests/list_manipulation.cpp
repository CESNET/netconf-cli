...
TEST_CASE("list manipulation")
{
    ...
    SECTION("moving (leaf)list instances")
    {
        ...
        SECTION("begin")
        {
            ...
            expected.m_destination = move_::Absolute::Begin;
        }
        ...
        SECTION("end")
        {
            ...
            expected.m_source.m_nodes.push_back(dataNode_{module_{"mod"}, leafListElement_{"addresses", "1.2.3.4"s}});
            expected.m_destination = move_::Absolute::End;
        }
        ...
        SECTION("after")
        {
            ...
            expected.m_source.m_nodes.push_back(dataNode_{module_{"mod"}, leafListElement_{"addresses", "1.2.3.4"s}});
            expected.m_destination = move_::Relative {
                move_::Relative::Position::After,
                leaf_data_{"0.0.0.0"s}
            };
        }
        ...
        SECTION("before")
        {
            ...
            expected.m_source.m_nodes.push_back(dataNode_{module_{"mod"}, leafListElement_{"addresses", "1.2.3.4"s}});
            expected.m_destination = move_::Relative {
                move_::Relative::Position::Before,
                leaf_data_{"0.0.0.0"s}
            };
        }
