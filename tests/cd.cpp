...
TEST_CASE("cd")
{
    ...
    ALLOW_CALL(*mockDatastore, getItems("example:list/number"))
        .RETURN(std::map<std::string, leaf_data_>{});
    ALLOW_CALL(*mockDatastore, getItems("example:twoKeyList/name"))
        .RETURN(std::map<std::string, leaf_data_>{});
    ALLOW_CALL(*mockDatastore, getItems("example:twoKeyList/number"))
        .RETURN(std::map<std::string, leaf_data_>{});
